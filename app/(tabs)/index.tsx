...
export default function HomeScreen() {
            ...
            render: () => (
              <View style={styles.highlightCard}>
                <View style={styles.highlightIconCircle}>
                  <Ionicons name="trophy" size={20} color="#0B0F0E" />
                </View>
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 24 }}>
      {loadError && (
        <TouchableOpacity onPress={loadData} style={{ backgroundColor: "#7f1d1d", margin: 20, marginBottom: 0, padding: 12, borderRadius: 10 }}>
          <Text style={{ color: "white", fontFamily: "Inter_500Medium", fontSize: 12, textAlign: "center" }}>
            Veriler yüklenemedi — tekrar denemek için dokun
          </Text>
        </TouchableOpacity>
      )}
      ...
      <TouchableOpacity onPress={() => router.push("/workout/start")} activeOpacity={0.85} style={{ marginHorizontal: 20, marginTop: 18 }}>
        <LinearGradient colors={["#16a34a", "#4ade80"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.ctaButton}>
          <View style={styles.ctaIconCircle}>
            <MaterialCommunityIcons name="dumbbell" size={18} color={COLORS.accent} />
          </View>
          <Text style={styles.ctaText}>Antrenmana Başla</Text>
          <Ionicons name="chevron-forward" size={20} color="#0B0F0E" />
        </LinearGradient>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  avatarCircle: { width: 44, height: 44, borderRadius: 22, backgroundColor: "rgba(34,197,94,0.15)", alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: COLORS.panelBorder },
  avatarLetter: { fontFamily: "Inter_700Bold", fontSize: 16, color: COLORS.accent },
  greetingSmall: { fontFamily: "Inter_400Regular", fontSize: 13, color: COLORS.textSecondary },
  greetingName: { fontFamily: "Inter_700Bold", fontSize: 17, color: COLORS.textPrimary, marginTop: 1 },
  iconPill: { width: 40, height: 40, borderRadius: 20, backgroundColor: COLORS.cardBg, alignItems: "center", justifyContent: "center" },
  notifDot: { position: "absolute", top: 9, right: 10, width: 6, height: 6, borderRadius: 3, backgroundColor: COLORS.accent },
  streakPill: { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: COLORS.cardBg, borderRadius: 20, paddingHorizontal: 12, height: 40 },
  streakPillText: { fontFamily: "Inter_700Bold", fontSize: 13, color: COLORS.textPrimary },
  heroPanel: { flexDirection: "row", backgroundColor: COLORS.panelBg, borderRadius: 24, marginHorizontal: 20, marginTop: 18, padding: 20, borderWidth: 1, borderColor: COLORS.panelBorder },
  heroLabel: { fontFamily: "Inter_500Medium", fontSize: 12, color: COLORS.textSecondary },
  heroNumber: { fontFamily: "BebasNeue_400Regular", fontSize: 56, color: COLORS.accent, lineHeight: 54 },
  heroUnit: { fontFamily: "Inter_500Medium", fontSize: 16, color: COLORS.textPrimary, marginLeft: 8, marginBottom: 8 },
  heroStatus: { fontFamily: "Inter_500Medium", fontSize: 13, color: COLORS.textSecondary, marginTop: 8 },
  weekRow: { flexDirection: "row", justifyContent: "space-between", marginTop: 18 },
  weekDayCol: { alignItems: "center", gap: 8 },
  weekDayLabel: { fontFamily: "Inter_500Medium", fontSize: 11, color: COLORS.textFaint },
  weekDot: { width: 9, height: 9, borderRadius: 5, backgroundColor: "rgba(255,255,255,0.12)" },
  weekDotFilled: { backgroundColor: COLORS.accent },
  weekDotToday: { borderWidth: 2, borderColor: "rgba(255,255,255,0.5)" },
  ctaButton: { flexDirection: "row", alignItems: "center", borderRadius: 18, paddingVertical: 14, paddingHorizontal: 14, gap: 12 },
  ctaIconCircle: { width: 36, height: 36, borderRadius: 18, backgroundColor: "#0B0F0E", alignItems: "center", justifyContent: "center" },
  ctaText: { flex: 1, fontFamily: "Inter_700Bold", fontSize: 16, color: "#0B0F0E" },
  statsCard: { flexDirection: "row", backgroundColor: COLORS.panelBg, borderRadius: 20, paddingVertical: 20, minHeight: 150, borderWidth: 1, borderColor: COLORS.divider },
  statCol: { flex: 1, alignItems: "center", gap: 6 },
  statDivider: { width: 1, backgroundColor: COLORS.divider },
  statIconCircle: { width: 30, height: 30, borderRadius: 15, backgroundColor: "rgba(34,197,94,0.12)", alignItems: "center", justifyContent: "center" },
  statNumber: { fontFamily: "BebasNeue_400Regular", fontSize: 24, color: COLORS.textPrimary },
  statNumberWord: { fontFamily: "Inter_700Bold", fontSize: 14, color: COLORS.textPrimary },
  statLabel: { fontFamily: "Inter_400Regular", fontSize: 11, color: COLORS.textSecondary },
  weekCard: { backgroundColor: COLORS.panelBg, borderRadius: 20, padding: 20, minHeight: 150, borderWidth: 1, borderColor: COLORS.divider, justifyContent: "center" },
  weekCardLabel: { fontFamily: "Inter_500Medium", fontSize: 12, color: COLORS.textSecondary },
  weekCardNumber: { fontFamily: "BebasNeue_400Regular", fontSize: 40, color: COLORS.textPrimary, lineHeight: 38 },
  weekCardUnit: { fontFamily: "Inter_500Medium", fontSize: 14, color: COLORS.textPrimary, marginLeft: 8, marginBottom: 4 },
  ...
  weekCardFooterText: { fontFamily: "Inter_400Regular", fontSize: 12, color: COLORS.textSecondary },
  highlightCard: { backgroundColor: COLORS.panelBg, borderRadius: 20, padding: 20, minHeight: 150, borderWidth: 1, borderColor: "rgba(34,197,94,0.3)", justifyContent: "center" },
  ...
  highlightLabel: { fontFamily: "Inter_500Medium", fontSize: 12, color: COLORS.textSecondary },
  highlightName: { fontFamily: "Inter_700Bold", fontSize: 16, color: COLORS.textPrimary, marginTop: 4 },
  highlightValue: { fontFamily: "BebasNeue_400Regular", fontSize: 34, color: COLORS.accent },
  highlightKind: { fontFamily: "Inter_400Regular", fontSize: 12, color: COLORS.textSecondary, marginTop: 2 },
  dotsRow: { flexDirection: "row", justifyContent: "center", gap: 6, marginTop: 12 },
  pageDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: "rgba(255,255,255,0.15)" },
  pageDotActive: { backgroundColor: COLORS.accent, width: 16 },
  sectionTitle: { fontFamily: "Inter_700Bold", fontSize: 17, color: COLORS.textPrimary, marginHorizontal: 20, marginTop: 26, marginBottom: 12 },
  quickCard: { flexDirection: "row", alignItems: "center", backgroundColor: COLORS.panelBg, borderRadius: 16, marginHorizontal: 20, marginTop: 10, padding: 14, gap: 12, borderWidth: 1, borderColor: COLORS.divider, overflow: "hidden" },
  quickAccentBar: { position: "absolute", left: 0, top: 0, bottom: 0, width: 3, backgroundColor: COLORS.accent },
  quickIconBox: { width: 40, height: 40, borderRadius: 12, backgroundColor: "rgba(34,197,94,0.12)", alignItems: "center", justifyContent: "center" },
  quickTitle: { fontFamily: "Inter_600SemiBold", fontSize: 15, color: COLORS.textPrimary },
  quickSubtitle: { fontFamily: "Inter_400Regular", fontSize: 12, color: COLORS.textSecondary, marginTop: 2 },
});
