...
// scripts/gen-types.sh veritabanındaki şemadan yeniden üretir.
// Daraltılmış tipler (ör. jsonb -> Record<...>) scripts/gen-types.mjs
// içindeki OVERRIDES tablosunda tutuluyor.
